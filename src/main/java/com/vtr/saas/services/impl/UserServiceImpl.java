...
import com.vtr.saas.mappers.UserMapper;
...
import com.vtr.saas.services.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse getUserById(String userId) {
        final String tenantId = TenantContext.getCurrentTenant();
        final User user = this.userRepository.findByIdAndNotDeleted(userId).orElseThrow(() -> new RuntimeException("User does not existing"));
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return this.userRepository.findByUsername(username).orElseThrow(() -> new UsernameNotFoundException("No user was found with: " + username));
    }
}
